...
NAME_KEYWORD_CATEGORIES = [
    ...
    (("baby", "newborn", "infant", "toddler", "diaper", "stroller",
      "pacifier"), "Baby", "🍼"),
    ...
    (("shoe", "sneaker", "sandal", "slipper", "boot", "insole",
      "sole"), "Footwear", "👟"),
    (("bag", "backpack", "purse", "wallet", "tote", "luggage", "card holder",
      "suitcase"), "Bags", "👜"),
    (("makeup", "beauty", "skincare", "hair", "cosmetic", "nail", "lipstick",
      "lash", "brow", "serum", "perfume", "blush", "comb", "wig",
      "microneedle", "roller", "toothbrush"), "Beauty", "💄"),
    (("massage", "slimming", "posture", "compression", "therapy", "prenatal",
      "brace", "orthopedic", "bandage", "arch support", "waist trainer",
      "fasciitis", "slim"), "Wellness", "🧘"),
    (("fitness", "gym", "yoga", "muscle", "workout", "dumbbell",
      "resistance"), "Fitness", "🏋️"),
    (("blender", "juicer", "kitchen", "cup", "mug", "cookware", "knife",
      "kettle", "spatula", "plate", "cutlery", "tumbler", "knives",
      "barbecue", "cocktail", "lunch box"), "Kitchen", "🍳"),
    (("humidifier", "light", "lamp", "led", "home", "decor", "cushion",
      "curtain", "pillow", "blanket", "vase", "candle", "clock", "wallpaper",
      "sticker", "plant", "basket", "ornament", "garden", "towel", "tapestry",
      "organizer"), "Home", "🏠"),
    (("usb", "charger", "bluetooth", "electronic", "speaker", "earbud",
      "camera", "wifi", "gps", "wireless", "projector",
      "flashlight"), "Electronics", "🔌"),
    (("phone", "iphone", "case"), "Phone Accessories", "📱"),
    (("toy", "kids", "children", "game", "plush", "doll", "blocks", "puzzle",
      "cosplay", "craft"), "Toys", "🧸"),
    (("dress", "shirt", "fashion", "clothing", "jacket", "coat", "hoodie",
      "sweater", "sweatshirt", "cardigan", "skirt", "legging", "pants",
      "blouse", "pajama", "scarf", "bra", "sock", "hat", "trousers",
      "underwear", "boxer", "romper", "headband", "sunglasses", "pantyhose",
      "blazer", "tights", "glove"), "Fashion", "👗"),
    (("outdoor", "camping", "hiking", "tent"), "Outdoor", "🏕️"),
    (("tool", "wrench", "repair", "drill", "ruler", "blade"), "Tools", "🛠️"),
    (("sport", "riding", "motorcycle", "helmet", "bicycle", "hunting",
      "fishing"), "Sports", "🧤"),
]
...
SUBGROUP_KEYWORDS = {
    ...
    "Baby": [
        (("diaper", "wipe", "changing"), "Diapering"),
        (("bottle", "pacifier", "feeding", "bib"), "Feeding"),
        (("bed", "crib", "cot", "blanket", "swaddle"), "Sleep"),
        (("stroller", "carrier", "car seat"), "On the Go"),
        (("romper", "onesie", "sock", "hat", "clothes"), "Clothing"),
    ],
    "Wellness": [
...
CATEGORY_DESCRIPTIONS = {
    ...
    "Baby": ["A practical little pick for the baby-gear pile.",
             "One of this week's most-picked baby items.",
             "Simple, everyday baby kit that keeps getting bought.",
             "An easy add for the nursery or the diaper bag."],
...
KEYWORD_SCOPE = {
    ...
    "baby": ("Baby", "Toys", "Fashion", "Wellness"),
