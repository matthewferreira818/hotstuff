...
date. Last post > 1 month ago = 🎯 prime prospect. Then send the DM._

## How to work this list (10 min/day)
1. Pick 3-5 names, check their IG/FB feed age on your phone.
2. Mark them below: 🎯 dead feed / ✅ active (skip) / ❓ no page found (also a
   prospect — "I'll build your page AND keep it alive").
3. DM or walk in — script at the bottom. 5 outreaches/day max, always
   personalized with their actual last-post month.
...
| CAVOK Brewing Co. | Dieppe | craft brewery/brewpub | 🔥 HOT LEAD: 08-04 owner call + samples-offer text · 08-06 bump sent (samples MADE — 7-card week in repo, Runway 11 name-drop). If reply: send pack same hour. If quiet: WALK-IN Fri 08-07 ~5 PM with printed pack |
...
> off. I run a local service that makes your page post every day automatically —
> you approve the style once and never touch it again. I built it for my own
> store first (it's posted 3x a day for months without me lifting a finger).
> Worth a 20-minute chat? No pressure either way — happy to just show you how
> it works.
